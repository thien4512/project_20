package com.example.thien.project_20;
...
public class MainActivity extends AppCompatActivity {
    ...
    String baseUrl = "http://starglobal.xyz/demo/iot/rest/application.php/get_login?user=thien&password=12345";  // This is the API base URL (GitHub API)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.hienthi = (TextView) findViewById(R.id.textView);
